...
import { useEmployeePortalData, type EmployeePortalDataType } from "@/lib/portals/useEmployeePortalData";
...
type EmployeePortalDataListProps = {
  type: EmployeePortalDataType;
  columns: Column[];
  emptyText: string;
};
...
export const employeePortalFormatters = {
  date: formatDate,
...
export default function EmployeePortalDataList({ type, columns, emptyText }: EmployeePortalDataListProps) {
  const { items, error, isLoading } = useEmployeePortalData(type);
